...
import { FaClock, FaMapMarkerAlt, FaExternalLinkAlt, FaUserGraduate, FaBriefcase } from "react-icons/fa";
...
export default function Drives() {
  ...
  return (
    <div className="student-hackathons-page">
      <h2 className="student-hackathon-heading">Placement Drives</h2>
