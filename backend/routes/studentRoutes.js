...
// GET: All students (for Admin Users page)
...
// DELETE: Remove a permission request
...
/* ======================
   TIMETABLE & SYLLABUS (STUDENT)
====================== */
router.get("/timetable", async (req, res) => {
  try {
    const { default: Timetable } = await import("../models/Timetable.js");
    const timetable = await Timetable.find({ role: "student" });
...
router.get("/syllabus", async (req, res) => {
  try {
    ...
    const syllabus = await Syllabus.find({ role: "student" });
